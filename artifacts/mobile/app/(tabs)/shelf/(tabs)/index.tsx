  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        ListEmptyComponent={
          searchQuery.trim() ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={[styles.emptyTitle, { color: colors.foreground }]}>Список пуст</Text>
              <Text style={[styles.emptySubtitle, { color: colors.mutedForeground }]}>Нажмите +, чтобы добавить первую книгу</Text>
            </View>
          )
        }
      />
      ...
      <RandomPickerModal
        ...
        books={list}
        onStartReading={(book) => { moveBook(book.id, 'reading'); setPickerVisible(false); }}
